...
const std::string SERVER_ADDRESS("tcp://mqtt.dioty.co:1883");
const std::string CLIENT_ID("sundaram_dubey");
const std::string TOPIC("/ravi123sehravat@gmail.com/narendra");
...
int main(int argc, char* argv[])
{
	...
	connOpts.set_user_name("ravi123sehravat@gmail.com");
	connOpts.set_password("0cb91e15");
