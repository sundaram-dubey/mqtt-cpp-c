...
const std::string DFLT_SERVER_ADDRESS	{ "tcp://mqtt.dioty.co:1883" };
const std::string DFLT_CLIENT_ID		{ "sundara_dubey_paytm" };

const string TOPIC { "/dubesundaram99@gmail.com/sundaram" };
...
int main(int argc, char* argv[])
{
	...
	conopts.set_user_name("dubesundaram99@gmail.com");
	conopts.set_password("5d263fb2");
